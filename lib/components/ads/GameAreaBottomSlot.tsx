...
export default function GameAreaBottomSlot() {
    ...
    useEffect(() => {
        ...
        const loadAd = async () => {
            try {
                ...
                const adCode = `<!-- 游戏区底部横幅广告2 -->
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-8041655671892982"
     data-ad-slot="7974269808"
     data-ad-format="auto"
...
<ins class="adsbygoogle"
    ...
    return (
        <div className="mt-4 z-20 relative w-full [&_.adsbygoogle]:!min-h-0 [&_.adsbygoogle]:!h-auto lg:block hidden" ref={adRef}>
        </div>
    );
}
