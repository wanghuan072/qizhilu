...
export default function AllGamesMobileVerticalSlot() {
    ...
    useEffect(() => {
        ...
        const loadAd = async () => {
            try {
                ...
                const adCode = `<!-- 移动端正方形广告1 -->
<ins class="adsbygoogle"
     style="display:block"
     data-ad-client="ca-pub-8041655671892982"
     data-ad-slot="4423420491"
     data-ad-format="auto"
...
<ins class="adsbygoogle"
    ...
    return (
        <div className="mt-4 z-20 relative w-full [&_.adsbygoogle]:!min-h-0 [&_.adsbygoogle]:!h-auto" ref={adRef}>
        </div>
    );
}
