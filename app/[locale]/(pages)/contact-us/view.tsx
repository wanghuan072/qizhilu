...
export default function ContactUsContent({
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			// Get API endpoint from environment variable, fallback to a default
			const apiEndpoint =
				process.env.NEXT_PUBLIC_WEB_API_URL ||
				"https://qizhilu.com/api/gateway/contact"

			// Get project ID from environment or use site name as fallback
			const projectId = process.env.NEXT_PUBLIC_PROJECT_ID || siteName
